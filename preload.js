...
contextBridge.exposeInMainWorld("tantalum", {
  ...
  agent: {
    ...
    listRestorePoints: (payload) => ipcRenderer.invoke("agent:restore-points:list", payload),
    recordRestorePoint: (payload) => ipcRenderer.invoke("agent:restore-points:record", payload),
    updateRestoreReviewStatus: (payload) => ipcRenderer.invoke("agent:restore-points:update-review-status", payload),
    restoreToMessage: (payload) => ipcRenderer.invoke("agent:restore-points:restore-to-message", payload),
  ...
  toolchain: {
    ...
    discardSourceRestoreMarker: (payload) => ipcRenderer.invoke("toolchain:discard-source-restore-marker", payload),
    listBoardCodeSnapshots: (payload) => ipcRenderer.invoke("toolchain:list-board-code-snapshots", payload),
    restoreBoardCodeSnapshot: (payload) => ipcRenderer.invoke("toolchain:restore-board-code-snapshot", payload),
    setBoardCodeVisibility: (payload) => ipcRenderer.invoke("toolchain:set-board-code-visibility", payload),
